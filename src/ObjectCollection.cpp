...
ObjectCollection::ObjectCollection(System_Drawable& drawableSystem, System_Collidable& collidableSystem) : drawables(drawableSystem), collidables(collidableSystem) {}
